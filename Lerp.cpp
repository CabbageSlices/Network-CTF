...
const float interpolate(const float& originValue, const float& destinationValue, const float& deltaFraction) {

    //calculate what fraction of the total distance should be moved
    float totalDistance = destinationValue - originValue;
